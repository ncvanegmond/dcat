...
# Class declarations
class ColumnCheckboxSelectMultiple(CheckboxSelectMultiple):
    """
    ...
    """
    def __init__(self, columns=NUMBER_OF_COLUMNS, css_class=None, **kwargs):
...
class MyModelAdmin(admin.ModelAdmin):
    formfield_overrides = {
        models.ManyToManyField: {'widget': ColumnCheckboxSelectMultiple},
    }
...
class Cryptoassetv1Admin(admin.ModelAdmin):
    fieldset = [
            ('General', {'fields': [{
                        'name',
                        'symbol',
...
admin.site.register(Cryptoasset, CryptoassetAdmin)
admin.site.register(CryptoassetVersionOne, Cryptoassetv1Admin)
